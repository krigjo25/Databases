...
CALL newPatient ('Aaron C. Crowder', '1960-09-07', '624492945', 'M', '7147672206', '178 Alpaca Way', 91505 , 103.6, 178,'O-', 'NNNNA', 'NNNND' , 'NNNNM' );
...
CALL newPatient ('Nicolas E. Abston' , '1983-06-06' , '023389720', 'M', '8646158470', '179 Pooh Bear Lane', 29673 , 47.3, 187,'A+', 'vAlergies', 'vDoc', 'vMed' );
CALL newPatient ('Tammy F. Dudley', '1989-02-25' , '136768137', 'M', '7329755329', '3687 Mahlon Street', 07733 , 59.28, 154,'O+', 'vAlergies', 'vDoc', 'vMed' );
...
CALL newPatient ('Jose J. Zuniga' , '1991-06-26' , '619927888', 'M' , '5627533058', '2828 Kerry Way', 90808 , 70.3, 187,'AB', 'vAlergies', 'vDoc', 'vMed' );
CALL newPatient ('Steven A. Crawford' , '1980-10-25' , '260574702', 'M' , '6785465620', '1472 Hanifan Lane', 30518 , 84.0, 168,'A+', 'vAlergies', 'vDoc', 'vMed' );
...
--  Diagnosis
CALL modifyPatient ('diagnoseID', 'GA04A', 10000);

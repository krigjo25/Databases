...
CALL newEmployee ('Sabrina R. McMahon', '1997-05-12', '4210 Norma Avenue', 75925, 'sabrmc@gmail.com', '830-890-3860', 25,'Radiologist', 'X-rayRoom');

CALL newEmployee ('Christopher S. Howard', '1974-03-30', '118 Cerullo Road', 84119, 'lilana_bart@yahoo.com', '4355146733', 100,'---', '---');
CALL newEmployee ('Roberto E. Marshall', '1953-05-05', '1068 Center Street', 93721, 'mariana_gay@gmail.com', '5592073271', 100,'----', '---');

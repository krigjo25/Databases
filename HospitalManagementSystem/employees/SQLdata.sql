...
CALL newEmployee ('Jon George', '1994-01-01', '118 Cerullo Road', 20001, 'billie.deck@hotmail.com', '406925436', 50,'General practitioner', 'ICU');
CALL newEmployee ('Eric E. West', '1975-07-23', '1164 Prospect Street', 08014, 'carli.barte@hotmail.com', '8567362941', 75,'General practitioner', 'ICU');
CALL newEmployee ('Michele R. Dejesus', '1969-06-12', '1698 Wescam Street', 89501, 'rasheed_wiega@gmail.com', '7758981143', 100,'General practitioner', 'ICU');
CALL newEmployee ('Brian A Benites', '1984-01-25', '2501 Woodland Terrace', 95630, 'allan2000@gmail.com','9169349710', 100,'General practitioner', 'ICU');
CALL newEmployee ('Brian M Howell', '1976-06-04', '2645 Foley Street', 33442, 'jake.lind1973@yahoo.com', '9546991607', 100,'General practitioner', 'ICU');
CALL newEmployee ('Loida G Newton', '1972-08-18', '552 Horizon Circle', 98119, 'barton2000@hotmail.com', '2536855251', 100,'General practitioner', 'ICU');
CALL newEmployee ('Julia A. Hanson', '1994-01-01', '118 Cerullo Road', 20001, 'frida2015@gmail.com', '9122491720', 100,'General practitioner', 'ICU');
